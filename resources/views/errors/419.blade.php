...
@section('content')
    <main class="h-screen w-full flex flex-col justify-center items-center bg-white">
        ...
        <div class="bg-yellow-100 px-4 py-2 text-sm font-medium text-black rounded-lg rotate-12 mb-10 shadow-md absolute">
            Session Expired
        </div>
        ...
        <p class="text-gray-500 mt-16 text-base">Your session has expired. Please refresh the page and try again.</p>
        ...
        <div class="absolute bottom-8 left-0 right-0 flex justify-center">
            <div class="w-24 h-1 bg-yellow-200 rounded-full"></div>
        </div>
    </main>
@endsection
