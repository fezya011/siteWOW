...
@section('content')
    <main class="h-screen w-full flex flex-col justify-center items-center bg-white">
        ...
        <div class="bg-orange-100 px-4 py-2 text-sm font-medium text-black rounded-lg rotate-12 mb-10 shadow-md absolute">
            Server Error
        </div>

        <div class="mt-8 relative">
            <a href="{{ route('home') }}" class="relative inline-block text-sm font-medium text-gray-700 group focus:outline-none">
                ...
                <span class="relative block px-8 py-3 bg-white border-2 border-gray-300 rounded-lg">
        ...
        <p class="text-gray-500 mt-16 text-base">Something went wrong on our end. Please try again later.</p>
        ...
        <div class="absolute bottom-8 left-0 right-0 flex justify-center">
            <div class="w-24 h-1 bg-orange-200 rounded-full"></div>
        </div>
    </main>
@endsection
